                ...
                <div class="relative overflow-hidden bg-gradient-to-r from-pcu-green to-emerald-500 py-20">
                    <div class="absolute inset-0">
                        <img alt="Life at MU" class="w-full h-full object-cover opacity-60"
                             src="https://picsum.photos/seed/mu-arrival-guide/1400/600"
                    ...
                    <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                            <div>
                                ...
                                <p class="text-white/75 text-lg max-w-3xl">Everything you need before departure and during arrival in Meadowvale.</p>
                            </div>
                    ...
                    <div class="grid lg:grid-cols-2 gap-10">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
                                ...
                                <ul class="space-y-4 text-gray-600">
                                    <li class="flex gap-3"><i class="w-5 h-5 text-pcu-green mt-1" data-lucide="map-pin"></i> Arrive at Meadowvale International Airport and use a trusted ride service to MU.</li>
                        ...
                        <div class="space-y-8">
                            <div class="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
                                ...
                                <p class="text-gray-600 mb-4">We recommend students have either Health &amp; Travel Insurance from their home country before arriving in Meadowvale. This is the preferred coverage for international students during the exchange period.</p>
