...
<img alt="MU Campus" class="w-full h-full object-cover opacity-60" src="https://picsum.photos/seed/mu-jdd-hero/1400/600" style="object-position: center 50%;"/>
</div>
...
<p class="text-white/80 text-lg max-w-3xl">Explore dual degree pathways that combine the best of MU and leading international universities.</p>
</div>
</div><!-- Content Section -->
...
<p class="text-gray-600 leading-relaxed mb-6">Earn one recognized degree awarded jointly by MU and an international partner university. Complete part of your studies at MU and part abroad.</p><span class="inline-flex items-center gap-2 px-6 py-3 bg-pcu-orange text-white font-semibold rounded-full group-hover:bg-amber-500 transition">Explore <i class="w-4 h-4" data-lucide="arrow-right"></i></span>
</div>
...
<p class="text-gray-600 leading-relaxed mb-6">Earn two separate degrees: one from MU and one from your partner university. Complete full programs at both institutions for dual credentials.</p><span class="inline-flex items-center gap-2 px-6 py-3 bg-amber-400 text-white font-semibold rounded-full group-hover:bg-amber-500 transition">Explore <i class="w-4 h-4" data-lucide="arrow-right"></i></span>
</div>
</div>
</div>
...
<p class="text-gray-700 leading-relaxed mb-6">A Joint Degree is a single degree awarded by two universities (MU and an international partner) to a student who has completed an integrated program of study. The degree recognizes the student's successful completion of requirements at both institutions and is officially conferred by both universities.</p>
...
<p class="text-sm text-gray-600">Study English language and literature with emphasis on cross-cultural communication and creative writing through both local and international perspectives.</p>
...
<p class="text-sm text-gray-600">Explore media, public relations, and communication strategies in a global context with hands-on experience in both Asian and global media landscapes.</p>
<div class="flex flex-wrap gap-2 mt-3">
...
<p class="text-sm text-gray-600">Master interior design principles combining contemporary design traditions with modern Korean design innovation and sustainable practices.</p>
<div class="flex flex-wrap gap-2 mt-3">
...
<p class="text-sm text-gray-600">Develop expertise in graphic design, branding, and digital visual communication informed by both local and Korean creative industries.</p>
<div class="flex flex-wrap gap-2 mt-3">
...
<p class="text-sm text-gray-600">Develop global business leadership skills combining MU's business practices with Dutch innovation and European market perspectives.</p>
<div class="flex flex-wrap gap-2 mt-3">
...
<div>
<h3 class="font-semibold text-pcu-blue text-lg mb-1">Year 1-2: Foundation at MU</h3>
<p class="text-gray-600">Complete core curriculum and foundational courses at MU in Meadowvale. Develop language skills and cultural understanding.</p>
</div>
</div>
<div class="flex gap-4">
<div class="flex flex-col items-center">
...
<p class="text-gray-600">Receive single degree officially awarded by both MU and partner university. Recognized globally.</p>
</div>
</div>
</div>
</div><!-- CTA -->
...
<p class="text-white/80 mb-8 max-w-2xl mx-auto">Combine the best of two worlds and earn an internationally recognized degree from MU and our esteemed partners.</p>
...
<p class="text-gray-700 leading-relaxed mb-6">A Double Degree program allows students to earn two separate but related degrees from two institutions. Students complete full degree requirements at both MU and an international partner university, receiving two distinct diplomas recognized by each institution.</p>
<div class="grid md:grid-cols-2 gap-6 mt-8">
...
<p class="text-sm text-gray-600">Comprehensive training in digital content creation, multimedia production, and creative storytelling combining Korean creative industry expertise with global market perspectives.</p>
<div class="flex flex-wrap gap-2 mt-3">
...
<div>
<h3 class="font-semibold text-pcu-blue text-lg mb-1">Year 1-2: Foundation at MU</h3>
<p class="text-gray-600">Complete core curriculum and foundational courses at MU in Meadowvale. Build strong academic foundation.</p>
</div>
</div>
<div class="flex gap-4">
<div class="flex flex-col items-center">
...
<p class="text-gray-600">Receive diplomas from both MU and partner university. Distinct credentials for global opportunity.</p>
</div>
</div>
</div>
</div><!-- CTA -->
